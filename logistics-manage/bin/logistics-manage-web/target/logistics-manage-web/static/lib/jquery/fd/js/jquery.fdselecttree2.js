...
(function($, window, document, undefined) {
    ...
    $(function() {
        var typeOpts = {
            ...
            department: {
                url: "api/basicdata/trees/department",
                name: "name",
                idKey: "id",
                pIdKey: "pid"
            }
        ...
        $.fn.FdSelectTree = function(options) {
            var textEl = this,
                textId = this.attr("id"),
                tempComboTemp = '<div id="tempComboContent" class="select-tree"><ul id="tempCombo" class="ztree" style="margin-top:0;max-height:300px; width:100%;"></ul></div>',
            ...
            function onBodyDown(event) {
                if (!(event.target.id == textId || event.target.id == "tempComboContent" || $(event.target)
                        .parents("#tempComboContent").length > 0)) {
                    hideMenu();
                }
            }
            ...
            // textEl.bind('input propertychange', searchNode);
