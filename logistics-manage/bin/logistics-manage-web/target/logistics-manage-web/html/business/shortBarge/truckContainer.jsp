			 ...
			 $.ajax({  
	                ...
	                success: function(data) {  
	                	...
	                	$("#carryContent").append("<li><label>发货皮重：</label><span>"+data.data.sendTare+"</span></li>"
								...
								+"<li><label>"+data.data.containerNumber1+"发货净重：</label><span>"+data.data.containerTwoSendNet+"</span></li>");
		...
		function exchangeProject(){
			...
			$.ajax({
				...
				success : function(data) {
					...
					$("input[name='transportType']").val(data.data.transportType);
		...
		<div class="form project_form container_top">
			<form class="form-inline maxWidth" id='orderSearchForm'>
				<div id="wrap">
					...
					<div class="form-group dataTimes">
						<label>至</label>
						<input id="d244" name='endDate' type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-M-d'})" />
						<i class="fa  fa-calendar-check-o " id="calendar2"></i>
					</div>
					<div class="form-group">
						<label>发货单位：</label>
					...
					<div class="tab-pane" id="panel3">
						<div class="domain">
							<div class="tableBg">
								...
								<a href="#" class="exportBtn msgbtn msg"><span>短信告知</span></a>
							</div>
							<div class="table-responsive">
								<!--历史运单开始-->
								<table class="table">
					...
					<div class="tab-pane" id="panel4">
						<div class="domain">
							<div class="tableBg">
								...
								<a href="javascript:void(0)" class="exportBtn export"><span>导出</span></a>
								<!-- <a href="javascript:void(0)" class="exportBtn del" id="recoveryBtn"><span>删除</span></a> -->
								<a href="javascript:void(0)" class="exportBtn msgbtn msg"><span>短信告知</span></a>
							...
							<div class="project_info">
								...
								<div class="form-inline">
									...
									<div class="form-group">
										...
										<input type="text" id="set_containerNumber1" name="containerNumber1" >
										
									</div>
									<div class="form-group">
										<label>集装箱号：</label>
										<!-- <select id="set_container_two" onchange="set_selectValue2()" name="containeNumber2Id"></select> -->
										<input type="text" id="set_containerNumber2" name="containerNumber2">
									</div>
						...
						<form id="sendId">
							...
							<div class="project_info">
								...
								<div class="form-inline ">
									...
									<div class="form-group"> 
										<label class="pLeft"><tb id="firContainer"></tb>发货净重：</label>
										<input type="text" maxlength="30" name="containerOneSendNet"/>
									</div>
									<div class="form-group">
										<label class="pLeft"><tb id="secContainer"></tb>发货净重：</label>
										<input type="text" maxlength="30" name="containerTwoSendNet"/>
									</div>
									<div class="form-group">
										<label>化验指标：</label>
						...
						<form id="receiptId">
							...
							<div class="project_info">
								...
								<div class="form-inline ">
									...
									<div class="form-group">
										<label class="pLeft"><tb id="receipt_1"></tb>收货净重：</label>
										<input type="text" maxlength="30" name="containerOneReceiptNet"/>
									</div>
								</div>
								<div class="form-inline">
									<div class="form-group">
										<label class="pLeft"><tb id="receipt_2"></tb>收货净重：</label>
										<input type="text" maxlength="30" name="containerTwoReceiptNet"/>
									</div>
								</div>
							</div>
							<hr />
		...
		<div class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" id="dispatchModal">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="dispatchId">
						<input type="hidden" id="selectVal1" name="containerNumber1" >
						<input type="hidden" id="selectVal2" name="containerNumber2">
							<div class="project_info">
								<h5>项目信息</h5>
							...
							<div class="project_info">
								...
								<div class="form-inline ">
									<div class="form-group">
										<label>集装箱号：</label>
										<!-- <select id="selectType1" name="containerNumber1Id" onchange="selectValue1()"></select> -->
										<input type="text" id="selectType1" name="containerNumber1" maxlength="30" />
									</div>
									<div class="form-group">
										<label>集装箱号：</label>
										<!-- <select id="selectType2" name="containerNumber2Id" onchange="selectValue2()"></select> -->
										<input type="text" id="selectType2" name="containerNumber2" maxlength="30" />
									</div>
									<div class="form-group">
										<label>货场：</label>
