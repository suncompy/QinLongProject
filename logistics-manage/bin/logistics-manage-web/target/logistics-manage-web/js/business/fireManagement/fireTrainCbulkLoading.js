$(function(){  
	...
	$(".tabbable .nav li").click(function(){
	  ...
	  $("body").on("click",".addBtn",function(){
		...
		<table class='table loadingTable'><thead><tr class='tableTop'><th>序号</th><th>车型</th><th>车号</th><th>装车载重</th></tr></thead>\
		...
		<td style='display:none'></td><td style='display:none'></td><td style='display:none'></td><td style='display:none'></td></tr></tbody></table>\
   ...
   var add = (function(start){  
    ...
    var iHtml = '';  
    return function(){
      iHtml = "<tr class='newTr'><td id="+ (count++) + " contentEditable='true'>"+ count +"</td><td contentEditable='true' onclick='gainSelectValue(this);'></td><td contentEditable='true'></td>" +
