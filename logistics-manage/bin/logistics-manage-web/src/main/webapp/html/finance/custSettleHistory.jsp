...
<script src="${pageContext.request.contextPath}/js/finance/custSettleHistory.js"></script>
</head>
...
<div class="container-fluid">
	...
	<div class="box-tools">
        ...
        <button class="btn-xs btn-primary pull-right" id="btnCustSettleAdd" style="display:none">结算</button>
    </div>
