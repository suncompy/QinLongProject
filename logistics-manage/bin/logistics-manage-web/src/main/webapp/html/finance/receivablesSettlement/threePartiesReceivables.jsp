...
<script src="${pageContext.request.contextPath}/js/finance/receivablesSettlement/threePartiesReceivables.js"></script>
</head>
...
<div class="container-fluid">
	...
	<div class="box-tools">
        ...
        <per:hasUrlPerm code="threePartiesReceivablesSettlement">
		   <button class="btn-xs btn-danger pull-right" id="btnCustomerAccountsSettlement">结算</button>
		 </per:hasUrlPerm>
        <per:hasUrlPerm code="addThreePartiesReceivables">
    ...
    <!--<div class="panel-heading">支出明细</div>  -->
        ...
        <div class="panel-body">
            ...
            <c:forEach items='${permissions }' var='permission' >
				<c:if test="${permission.code=='addThreePartiesReceivablesAuit'}">
					<button class="btn-xs btn-primary pull-right " id="btnDriverCheckDetailAproveFinance">财务审核</button>
				</c:if>
		</c:forEach>
