...
<script src="${pageContext.request.contextPath}/js/finance/customerPackOrder.js"></script>
</head>
...
<div class="container-fluid">
    <div class="panel panel-default">
	   ...
	   <form class="form-horizontal" id="frmCustomerPackOrderQuery">
	    <div class="form-group">
                <label class="col-md-1 control-label">客户对账打包信息id</label>
                <div class="col-md-2">
                    <input class="form-control" name="custPackId" type="text">
                </div>
	        <div class="col-md-4">
                    <button class="btn btn-primary" id="btnCustomerPackOrderQuery">查询</button>
                </div>
            </div>
	  </form>
        </div>
	...
	<div class="box-header with-border">
	    ...
	    <h3 class="box-title">客户打包-运单中间表信息</h3>
	</div>
	<div class="box-tools">
            <button class="btn btn-primary" id="btnCustomerPackOrderAdd">新增</button>
            <button class="btn btn-primary" id="btnCustomerPackOrderEdit">修改</button>
	    <button class="btn btn-primary" id="btnCustomerPackOrderView">查看</button>
            <button class="btn btn-danger" id="btnCustomerPackOrderDel">删除</button>
        </div>
	<table id="tblCustomerPackOrder" class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
	    <thead>
		<tr>
		    <th>主键</th>
		    <th>客户对账打包信息id</th>
    ...
    <!-- 模态框（Modal） -->
    <div class="modal fade" id="mdlCustomerPackOrder" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog large">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">客户打包-运单中间表信息</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" id="frmCustomerPackOrder">
                        <input class="hidden" name="id" />
                        <div class="form-group">
                            <label class="col-md-2 control-label">主键</label>
                            <div class="col-md-4">
                                <input class="form-control" name="custPackOrderId" maxlength="32" type="text"/>
                            </div>
                            <label class="col-md-2 control-label">客户对账打包信息id</label>
                            <div class="col-md-4">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" id="btnCustomerPackOrderSave">保存</button>
