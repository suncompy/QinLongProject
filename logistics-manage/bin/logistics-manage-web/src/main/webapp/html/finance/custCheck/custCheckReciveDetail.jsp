...
<script src="${pageContext.request.contextPath}/js/finance/custCheck/custCheckReciveDetail.js"></script>
</head>
...
<body>
  <div class="box box-primary table-responsive">
   	<div class="box-tools">
        ...
        <per:hasUrlPerm code="custCheckDetailAproveFinanceByReceive">
		    <button class="btn-xs btn-primary pull-right checks" id="btnCustCheckDetailAproveFinance">财务审核</button>
		 </per:hasUrlPerm>
		  <per:hasUrlPerm code="custCheckDetailUnpackByReceive">
