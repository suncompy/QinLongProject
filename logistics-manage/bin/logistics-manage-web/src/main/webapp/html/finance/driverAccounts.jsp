...
<html>
	...
	<head lang="zh-CN">
		...
		<script src="${pageContext.request.contextPath}/js/finance/settlementAccountability/driverAccounts.js"></script>
	</head>
	...
	<body>
		<div class="container-fluid">
			...
			<div class="box box-primary table-responsive">
				<div class="box-tools">					
					<button class="btn-xs btn-primary tableActive" id="btnDriverAccountsDetail">结算明细</button>
					<button class="btn-xs btn-primary" id="btnDriverAccountsHistoryDetail">历史明细</button>
					<button class="btn-xs btn-danger pull-right" id="btnDriverAccountsAgainstAudit" style="display:none">反审核</button>
					...
					<per:hasUrlPerm code="driverAccountsSettlement">
					   <button class="btn-xs btn-primary pull-right" id="btnDriverAccountsSettlement">结算</button>
					 </per:hasUrlPerm>
					<per:hasUrlPerm code="driverAccountsSettlementStart">
					  <button class="btn-xs btn-primary pull-right" id="btnDriverAccountsSettlementStart">开始结算</button>
					 </per:hasUrlPerm>
				</div>
							...
							<form class="form-horizontal" id="chooseProjectFormId">
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<input name="receiver" readonly="readonly" />
										</div>
									...
									<div class="form-group">
										...
										<label class="col-md-1 control-label" style="display:none">行号</label>
										<div class="col-md-2"  style="display:none">
											<input name="receiveOpenBankNum" readonly="readonly" />
										</div>
										<label class="col-md-1 control-label" style="display:none">操作人</label>
										<div class="col-md-2" style="display:none">
											<input name="suppliesExecuteName" readonly="readonly" />
										</div>
									</div>
								</fieldset>
								<fieldset>
...
<i class='requireds'>*</i></span>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<select name="provideCompanyId"></select>
										</div>
									</div>
								</fieldset>
							</form>
