...
<script src="${pageContext.request.contextPath}/js/finance/custCheck/custCheckRecivePack.js"></script>
</head>
...
<body>
  <div class="box box-primary table-responsive">
   	<div class="box-tools">
        ...
        <button class="btn-xs btn-primary" key="1" id="btnCustCheckRecive" disabled="disabled">明细</button>
