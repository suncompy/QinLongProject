...
//根据选中的短驳运单财务表,获得该指标表
 var reloadPoint = function() {
  ...
  function loadqueryCondition(){
    ...
    queryCondition.beginDateOilgas = $("#frmDotAccountsQuery [name=beginDate]").val();
    queryCondition.endDateOilgas = $("#frmDotAccountsQuery [name=endDate]").val();
  ...
  var getOilGasCards = function(source, data, callback) {
	 ...
	 $("#btnDotAccountsDetail").click(function(e) {
		    e.preventDefault();
		    window.open("dotAccounts.do", "contentIframe");  
	  });
