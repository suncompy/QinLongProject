          ...
          <div class="modal-body">
            ...
            <form class="form-horizontal" id="forgetId">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-xs-9">
                       <input type="email" class="form-control" id="exampleInputEmail1" placeholder="请输入手机号">
                     </div>
                   </div>
                   <div class="form-group">
                      <label class="col-xs-3 control-label">验证码：</label>
                      <div class="col-xs-5">
                        <input type="email" class="form-control" id="exampleInputEmail1" placeholder="请输入验证码">
                      </div>
                      <div class="col-xs-4">
