...
<script src="${pageContext.request.contextPath}/js/finance/customerCheckingConf.js"></script>
</head>
...
<div class="container-fluid">
    <div class="panel panel-default">
	   ...
	   <form class="form-horizontal" id="frmCustomerCheckingConfQuery">
	    <div class="form-group">
	        ...
	        <div class="col-md-4">
                    <button class="btn btn-primary" id="btnCustomerCheckingConfQuery">查询</button>
                </div>
            </div>
	  </form>
        </div>
	...
	<div class="box-header with-border">
	    ...
	    <h3 class="box-title">客户对账设置表信息</h3>
	</div>
	<div class="box-tools">
            <button class="btn btn-primary" id="btnCustomerCheckingConfAdd">新增</button>
            <button class="btn btn-primary" id="btnCustomerCheckingConfEdit">修改</button>
	    <button class="btn btn-primary" id="btnCustomerCheckingConfView">查看</button>
            <button class="btn btn-danger" id="btnCustomerCheckingConfDel">删除</button>
        </div>
	<table id="tblCustomerCheckingConf" class="table table-striped table-bordered" cellspacing="0" width="100%">
	    <thead>
		<tr>
		    <th>主键</th>
		    <th>项目id</th>
		    <th>开始日期</th>
		    <th>结束日期</th>
		    <th>对账状态(0-新建 1-待审核 2-财务审核通过)</th>
    ...
    <!-- 模态框（Modal） -->
    <div class="modal fade" id="mdlCustomerCheckingConf" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog large">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">客户对账设置表信息</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" id="frmCustomerCheckingConf">
                        <input class="hidden" name="id" />
                        <div class="form-group">
                            <label class="col-md-2 control-label">主键</label>
                            <div class="col-md-4">
                                <input class="form-control" name="custCheckConId" maxlength="32" type="text"/>
                            </div>
				...
				<input class="form-control" name="startDate" type="text" data-provide="datepicker"/>
			      </span>
                            </div>
                            <label class="col-md-2 control-label">结束日期</label>
                            <div class="col-md-4">
                              <span style="position: relative; z-index: 9999;">
				<input class="form-control" name="endDate" type="text" data-provide="datepicker"/>
			      </span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">对账状态(0-新建 1-待审核 2-财务审核通过)</label>
                            <div class="col-md-4">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" id="btnCustomerCheckingConfSave">保存</button>
