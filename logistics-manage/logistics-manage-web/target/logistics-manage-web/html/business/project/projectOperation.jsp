		...
		<div class="form project_form container_top">
			<form class="form-inline project-form maxWidth" id="searchForm">
				<div id="wrap">
					...
					<div class="form-group" onmouseover="listBranchGroup()">
						<label>分支机构：</label>
		...
		$.ajax({  
	    	...
	    	success:function(data){
	    		...
	    		if(data.status==200){
	    			...
	    			var content ='<dl style="text-align: center;"><dd>货位为空</dd></dl>'
	    			$.each(cargoLocations,function(index,stock){
	    				if(stock.projectType===0){//集装箱
	    					/* content="<dl>"
								+"<dt>项目编号</dt>"
								+"<dd>"+stock.projectCode+"</dd>"
								+"<dt>货位吨位</dt>"
								+"<dd>"+stock.currentQty+"</dd>"
								+"<dt>集装箱组</dt>"
								+"<dd>"+stock.containerNum+"</dd>"
								+"</dl>";*/
							content="<dl>"
	    				...
	    				$('#cargoLocation').append("<li><div class='depot-num'>"+stock.cargoLocationName+"</div><div class='clearfix depot-detail'>"
