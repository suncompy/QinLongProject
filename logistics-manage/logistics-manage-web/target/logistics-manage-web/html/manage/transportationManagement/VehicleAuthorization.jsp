			...
			<form class="form-inline maxWidth">
				<div id="wrap">
					...
					<div class="form-group dataTimes">
						...
						<input endDate="endDate" type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-M-d'})" />
						<i class="fa  fa-calendar-check-o " id="calendar2"></i>
					</div>
	...
	<div class="container_top tableDiv">
		<div class="tabbable">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#panel1" data-toggle="tab">挂靠列表</a></li>
				<li><a href="#panel2" data-toggle="tab">申请列表</a></li>
				<li><a href="#panel3" data-toggle="tab">已驳回</a></li>
			</ul>
					...
					<div class="modal-body">
						...
						<div class="row clearfix ">
							<div class="col-md-12 column modal_btn">
								<button type="button"class="btn cancleBtn" data-dismiss="modal" onclick="sureRemind(1)">确定</button>
...
<script>
	function searchByPage(num){
		$.ajax({  
        	type:'post',      
       		url:'${pageContext.request.contextPath}/byPage/anchored/list.do',  
	...
	function htmlTable(results){
		...
		$.each(anList,function(index,it){
			if(it.status ==1){
    			...
    			$('#tbody_1').append("<tr> <td> <label class='demo--label'> <input"
								+"class='demo--checkbox' type='checkbox' value='"+it.recordId+"' > <span"
								+"class='demo--checkboxInput'> </span> </label> </td>"
						+"<td>"+it.name+"</td> "
						+"<td>"+type+"</td> "
			...
			if(it.status ==0){
    			...
    			$('#tbody_2').append("<tr> <td> <label class='demo--label'> <input"
								+"class='demo--checkbox' type='checkbox' value='"+it.recordId+"' > <span"
								+"class='demo--checkboxInput'> </span> </label> </td>"
						+"<td>"+it.name+"</td> "
						+"<td>"+types+"</td> "
			...
			if(it.status ==3){
    			...
    			$('#tbody_3').append("<tr> <td> <label class='demo--label'> <input"
								+"class='demo--checkbox' type='checkbox' value='"+it.recordId+"' > <span"
								+"class='demo--checkboxInput'> </span> </label> </td>"
						+"<td>"+it.name+"</td> "
						+"<td>"+types+"</td> "
