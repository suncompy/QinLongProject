					...
					<div class="modal-body">
                     <form id="addUserForm">
							...
							<div class="form-inline">
								...
								<div class="form-group">
									<label>&emsp;&emsp;&emsp;&emsp;简称：</label>
								...
								<div class="form-group">
									<label>&emsp;&emsp;&emsp;&emsp;部门：</label>
							...
							<div class="form-inline">
								...
								<div class="form-group">
									<label>&emsp;&emsp;&emsp;&emsp;传真：</label>
						...
						<div class="whole clearfix" >
							<ul class="clearfix">
								...
								<li>
									...
									<span>13487536097</span>
								</li>
								<li>
									<label>&emsp;关联业务：</label>
									<span>J0001</span>
								</li>
								<li>
									<label>&emsp;&emsp;阶段：</label>
									<span>接取</span>
								</li>
							</ul>
							<ul class="clearfix">
		        	...
		        	success:function(data){
		        		if(data.status==200){
							...
							$.each(customerInfo.businessContacts,function(index,businessContact){
								...
								+"<option name='projectId' value='${project.id }'>${project.projectCode }</option></c:forEach></select><input type='hidden' name='relateProjectCode' /></div>"
								+"<div class='form-group'> <label>&emsp;&emsp;&emsp;阶段：</label> <select name='stage'><option value='0'>接取</option><option value='1'>送达</option><option value='2'>汽运</option><option value='3'>火运</option></select></div></div>"
	...
	<script type="text/javascript">
		...
		/*<!--关联增加 减少-->*/
			...
			$(".add-more").click(function(){
				...
				+"<div class='form-group'> <label>&emsp;关联业务：</label> <select  name='relateProjectId' onchange='relateProject(this)'><c:forEach items='${projects }' var='project' >"
				+"<option value='${project.id }'>${project.projectCode }</option></c:forEach></select><input type='hidden' name='relateProjectCode' /></div>"
				+"<div class='form-group'> <label>&emsp;&emsp;&emsp;阶段：</label> <select name='stage'><option value='0'>接取</option><option value='1'>送达</option><option value='2'>汽运</option><option value='3'>火运</option></select></div></div>"
