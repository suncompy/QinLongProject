...
<script src="${pageContext.request.contextPath}/js/finance/settlementAccountability/dotAccountability.js"></script>
<style>
...
<div class="container-fluid">
    ...
    <div class="box box-primary table-responsive">
    	<div class="box-tools">
				<button class="btn-xs btn-primary tableActive" id="btnDotAccountability">列表</button>
				<button class="btn-xs btn-primary " id="btnDotAccountabilityDetail">交账明细</button>
				...
				<c:forEach items='${permissions }' var='permission' >
					<c:if test="${permission.code=='dotAccountabilityPack'}">
    ...
    <div class="modal fade" id="accountpackingModal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog" style="width: 1100px">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">交账打包</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" id="packForm">
                    <input name="shPackIds" type="hidden" />
                    <fieldset>
                      	<legend>
							<span style="font-size: 12px; color: red;">打包信息<i class='requireds'>*</i></span>
						</legend>
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input name="nowDate" disabled="disabled"/>
                            </div>
                            <label class="col-md-1 control-label">包内总单数</label>
                            <div class="col-md-2">
                                <input name="packTruckNum" readonly="readonly" />
                            </div>
                            <label class="col-md-1 control-label">包内总金额</label>
                            <div class="col-md-2">
                        ...
                        <fieldset id="settleInformation">
                          <legend>
							<span style="font-size: 12px; color: red;">项目部剩余</span><i class='requireds'>*</i>
						  </legend>
						  <div class="box box-primary">
							<div class="box-tools" name="boxtools">
								<div class="form-group">
		                            <label class="col-md-1 control-label">剩余油卡</label>
		                            <div class="col-md-2">
		                            		<input name="surplusOilCard"  disabled="disabled" />
		                            </div>
		                            <label class="col-md-1 control-label">剩余气卡</label>
		                            <div class="col-md-2">
		                                <input name="surplusGasCard"  disabled="disabled" />
		                            </div>
		                        </div>
	                        </div>
						</div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" id="btnAddDotAccountPack">打包</button>
