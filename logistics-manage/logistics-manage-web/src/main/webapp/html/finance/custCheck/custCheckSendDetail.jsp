...
<script src="${pageContext.request.contextPath}/js/finance/custCheck/custCheckSendDetail.js"></script>
</head>
  ...
  <div class="box box-primary table-responsive">
   	<div class="box-tools">
        ...
        <button class="btn-xs btn-danger pull-right" id="btnCustCheckDetailDeaproveFinance" style="display:none">反审核</button>
   		<per:hasUrlPerm code="custCheckDetailAproveFinanceBySend">
		   <button class="btn-xs btn-primary pull-right checks" id="btnCustCheckDetailAproveFinance">财务审核</button>
		 </per:hasUrlPerm>
		 <per:hasUrlPerm code="custCheckDetailUnpackBySend">
