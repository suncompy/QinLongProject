...
<script src="${pageContext.request.contextPath}/js/finance/custCheck/custCheckCar.js"></script>
</head>
...
<body>
  <div class="box box-primary table-responsive">
	...
	<table id="tblShortPack" class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
	    <thead>
		<tr>
		    <th></th>
		    <th>运单编号</th>
