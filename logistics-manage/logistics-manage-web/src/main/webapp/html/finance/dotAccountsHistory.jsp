...
<script src="${pageContext.request.contextPath}/js/finance/settlementAccountability/dotAccountsHistory.js"></script>
<style>
...
<div class="container-fluid">
    ...
    <div class="box box-primary table-responsive">
			<div class="box-tools">
				<button class="btn-xs btn-primary " id="btnDotAccountsDetail">对账明细</button>
				<button class="btn-xs btn-primary tableActive" id="btnDotAccountsHistoryDetail">历史明细</button>
