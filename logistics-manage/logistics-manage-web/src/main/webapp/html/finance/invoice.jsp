...
<script src="${pageContext.request.contextPath}/js/finance/invoice.js"></script>
</head>
...
<div class="container-fluid">
    <div class="panel panel-default">
	   ...
	   <form class="form-inline maxWidth" id="frmInvoiceQuery">
		...
		<div class="form-group"> 
            <button class="btn-xs btn-primary btn-query pull-right" id="btnInvoiceQuery">查询</button>
	    </div>
	  </form>
        </div>
    </div>
	...
	<div class="box-tools">
			<button class="btn-xs btn-primary tableActive" id="btnInvoiceDetail">发票列表</button>
            <button class="btn-xs btn-primary  pull-right" id="btnInvoiceCancelNoAudit">发票作废反审核</button>
            <button class="btn-xs btn-primary  pull-right" id="btnInvoiceCancelAudit">发票作废审核</button>
	    	<button class="btn-xs btn-primary  pull-right" id="btnInvoiceCancel">发票作废</button>
            <button class="btn-xs btn-danger pull-right" id="btnInvoiceBind">发票登入</button>
        </div>
	<table id="tblInvoice" class="table table-striped table-bordered" cellspacing="0" width="100%">
	    <thead>
		<tr>
			<th>
	    ...
	    <tbody></tbody>
			...
			<!-- 发票登入模态框-->
			<div class="modal fade" id="InvoiceAddModal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="true">
							...
							<form class="form-horizontal" id="chooseProjectFormId">
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<input name="trainFlagName" readonly="readonly"/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-2">
											<input name="openInvoiceProject" id="openInvoiceProject" readonly="readonly"/>
										</div>
...
<i class='requireds'>*</i></span>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<input name="receiveTypeName" value="客户" style="display:none" disabled="disabled"/>
...
<i class='requireds'>*</i></span>
						...
						<div class="modal-footer">
							<button class="btn-xs btn-primary" id="btnInvoiceQueryProjectId">登入</button>
