...
<html>
	...
	<head lang="zh-CN">
		...
		<script src="${pageContext.request.contextPath}/js/business/project/projectCheck2.js"></script>
	</head>
...
.c-form-0424 .select2-selection{
			...
			<div class="box box-primary table-responsive">
				...
				<div class="tableBg">
					...
					<button class="btn-xs btn-primary" id="projectCheck1">项目明细</button>
					<button class="btn-xs btn-primary tableActive" id="projectCheck2">项目核算</button>
					<!-- <a class="export" onclick="return false;" id="btnProjectCheck2Export"><span>导出</span></a>-->
					<c:forEach items='${permissions }' var='permission' >
						<c:if test="${permission.code=='btnProjectCheckDetailExport'}">
							<button class="btn-xs btn-primary pull-right exprotbtn" id="btnProjectCheck2Export">导出</button>
						</c:if>
					</c:forEach>
			    </div>
				</div>
				<table id="tblProjectCheck2" class="table table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>
