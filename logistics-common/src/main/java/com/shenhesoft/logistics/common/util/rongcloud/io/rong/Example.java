package com.shenhesoft.logistics.common.util.rongcloud.io.rong;

import java.io.FileInputStream;
import java.io.InputStreamReader;
import java.io.Reader;

import com.shenhesoft.logistics.common.util.rongcloud.io.rong.messages.TxtMessage;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.messages.VoiceMessage;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.ChatRoomInfo;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.ChatroomQueryResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.ChatroomUserQueryResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.CheckOnlineResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.CodeSuccessResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.GroupInfo;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.GroupUserQueryResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.HistoryMessageResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.ListBlockChatroomUserResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.ListGagChatroomUserResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.ListGagGroupUserResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.ListWordfilterResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.PushMessage;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.QueryBlacklistUserResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.QueryBlockUserResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.SMSImageCodeResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.SMSSendCodeResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.SMSVerifyCodeResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.TemplateMessage;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.TokenResult;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.models.UserTag;
import com.shenhesoft.logistics.common.util.rongcloud.io.rong.util.GsonUtil;

/**
 * 一些api的调用示例
 */
public class Example {
	private static final String JSONFILE = Example.class.getResource ("").getFile().replace("/io/rong/", "/") + "jsonsource/";
	
	public static void main(String[] args) throws Exception {
		String appKey = "pwe86ga5pib06";//替换成您的appkey
		String appSecret = "Nrds8RZqe24K";//替换成匹配上面key的secret
		
		RongCloud rongCloud = RongCloud.getInstance(appKey, appSecret);
		
		System.out.println("************************User********************");
		// 获取 Token 方法 
		TokenResult userGetTokenResult = rongCloud.user.getToken("123", "username", "http://www.rongcloud.cn/images/logo.png");
