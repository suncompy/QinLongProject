package com.shenhesoft.logistics.common.util.httpclient;
...
//		HttpClientUtil ac = new HttpClientUtil("http://127.0.0.1:8082/app/login/systemUserDoLogin.do");
//		Map<String, String> map = new HashMap<String, String>();
//		map.put("userName", "admin");
//		map.put("password", "123456");
//		String arry = JsonUtils.objectToJson(map);
